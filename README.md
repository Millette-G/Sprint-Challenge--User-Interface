...
Semantic HTML gives meaning to the web page not just the presentation.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

The block element is an entire block of HTML that tolerates no elements next to it unless orderd to by other HTML. The inline element goes inside of a block.
...
Git allows multiple developers to work on the same project "Safely".
